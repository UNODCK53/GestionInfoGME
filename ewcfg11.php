...
define("EW_PROJECT_NAME", "gestioninfogme", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{D6213859-7C64-4DB8-BACE-8E97DF9FA7FD}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'C6gle29bStSa99nf', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/gestioninfogme.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", '10.1.2.17', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'gestioninfogme', TRUE);
define("EW_CONN_PASS", 'gestioninfogme', TRUE);
define("EW_CONN_DB", 'gestioninfogme', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "gestioninfogme", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "gestioninfogme", TRUE); // Administrator password
