...
$grafica_produccion = NULL;

//
// Table class for grafica_produccion
//
class cgrafica_produccion extends cTable {
	var $GME_Activos;
	...
	function __construct() {
		...
		$this->TableVar = 'grafica_produccion';
		$this->TableName = 'grafica_produccion';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// GME_Activos
		$this->GME_Activos = new cField('grafica_produccion', 'grafica_produccion', 'x_GME_Activos', 'GME_Activos', '`GME_Activos`', '`GME_Activos`', 20, -1, FALSE, '`GME_Activos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GME_Activos->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GME_Activos'] = &$this->GME_Activos;

		// Total_erradicado
		$this->Total_erradicado = new cField('grafica_produccion', 'grafica_produccion', 'x_Total_erradicado', 'Total_erradicado', '`Total_erradicado`', '`Total_erradicado`', 131, -1, FALSE, '`Total_erradicado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`grafica_produccion`";
	}
	...
	// Update Table
	var $UpdateTable = "`grafica_produccion`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "grafica_produccionlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("grafica_produccionview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("grafica_produccionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "grafica_produccionadd.php?" . $this->UrlParm($parm);
		else
			return "grafica_produccionadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("grafica_produccionedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("grafica_produccionadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("grafica_producciondelete.php", $this->UrlParm());
	}
