...
//
// Table class for info_diario
//
class cinfo_diario extends cTable {
	var $llave;
	var $USUARIO;
	var $Cargo_gme;
	var $NOM_PE;
	...
	function __construct() {
		...
		$this->TableVar = 'info_diario';
		$this->TableName = 'info_diario';
		...
		// llave
		$this->llave = new cField('info_diario', 'info_diario', 'x_llave', 'llave', '`llave`', '`llave`', 200, -1, FALSE, '`llave`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['llave'] = &$this->llave;

		// USUARIO
		$this->USUARIO = new cField('info_diario', 'info_diario', 'x_USUARIO', 'USUARIO', '`USUARIO`', '`USUARIO`', 201, -1, FALSE, '`USUARIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['USUARIO'] = &$this->USUARIO;

		// Cargo_gme
		$this->Cargo_gme = new cField('info_diario', 'info_diario', 'x_Cargo_gme', 'Cargo_gme', '`Cargo_gme`', '`Cargo_gme`', 200, -1, FALSE, '`Cargo_gme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cargo_gme'] = &$this->Cargo_gme;

		// NOM_PE
		$this->NOM_PE = new cField('info_diario', 'info_diario', 'x_NOM_PE', 'NOM_PE', '`NOM_PE`', '`NOM_PE`', 201, -1, FALSE, '`NOM_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_PE'] = &$this->NOM_PE;

		// Otro_PE
		$this->Otro_PE = new cField('info_diario', 'info_diario', 'x_Otro_PE', 'Otro_PE', '`Otro_PE`', '`Otro_PE`', 200, -1, FALSE, '`Otro_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_PE'] = &$this->Otro_PE;

		// NOM_PGE
		$this->NOM_PGE = new cField('info_diario', 'info_diario', 'x_NOM_PGE', 'NOM_PGE', '`NOM_PGE`', '`NOM_PGE`', 201, -1, FALSE, '`NOM_PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_PGE'] = &$this->NOM_PGE;

		// Otro_NOM_PGE
		$this->Otro_NOM_PGE = new cField('info_diario', 'info_diario', 'x_Otro_NOM_PGE', 'Otro_NOM_PGE', '`Otro_NOM_PGE`', '`Otro_NOM_PGE`', 200, -1, FALSE, '`Otro_NOM_PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_NOM_PGE'] = &$this->Otro_NOM_PGE;

		// Otro_CC_PGE
		$this->Otro_CC_PGE = new cField('info_diario', 'info_diario', 'x_Otro_CC_PGE', 'Otro_CC_PGE', '`Otro_CC_PGE`', '`Otro_CC_PGE`', 200, -1, FALSE, '`Otro_CC_PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_CC_PGE'] = &$this->Otro_CC_PGE;

		// TIPO_INFORME
		$this->TIPO_INFORME = new cField('info_diario', 'info_diario', 'x_TIPO_INFORME', 'TIPO_INFORME', '`TIPO_INFORME`', '`TIPO_INFORME`', 201, -1, FALSE, '`TIPO_INFORME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TIPO_INFORME'] = &$this->TIPO_INFORME;

		// FECHA_REPORT
		$this->FECHA_REPORT = new cField('info_diario', 'info_diario', 'x_FECHA_REPORT', 'FECHA_REPORT', '`FECHA_REPORT`', '`FECHA_REPORT`', 200, -1, FALSE, '`FECHA_REPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FECHA_REPORT'] = &$this->FECHA_REPORT;

		// DIA
		$this->DIA = new cField('info_diario', 'info_diario', 'x_DIA', 'DIA', '`DIA`', '`DIA`', 200, -1, FALSE, '`DIA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['DIA'] = &$this->DIA;

		// MES
		$this->MES = new cField('info_diario', 'info_diario', 'x_MES', 'MES', '`MES`', '`MES`', 200, -1, FALSE, '`MES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MES'] = &$this->MES;

		// Departamento
		$this->Departamento = new cField('info_diario', 'info_diario', 'x_Departamento', 'Departamento', '`Departamento`', '`Departamento`', 200, -1, FALSE, '`Departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Departamento'] = &$this->Departamento;

		// Muncipio
		$this->Muncipio = new cField('info_diario', 'info_diario', 'x_Muncipio', 'Muncipio', '`Muncipio`', '`Muncipio`', 201, -1, FALSE, '`Muncipio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Muncipio'] = &$this->Muncipio;

		// NOM_VDA
		$this->NOM_VDA = new cField('info_diario', 'info_diario', 'x_NOM_VDA', 'NOM_VDA', '`NOM_VDA`', '`NOM_VDA`', 200, -1, FALSE, '`NOM_VDA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_VDA'] = &$this->NOM_VDA;

		// Ha_Coca
		$this->Ha_Coca = new cField('info_diario', 'info_diario', 'x_Ha_Coca', 'Ha_Coca', '`Ha_Coca`', '`Ha_Coca`', 131, -1, FALSE, '`Ha_Coca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ha_Coca->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ha_Coca'] = &$this->Ha_Coca;

		// Ha_Amapola
		$this->Ha_Amapola = new cField('info_diario', 'info_diario', 'x_Ha_Amapola', 'Ha_Amapola', '`Ha_Amapola`', '`Ha_Amapola`', 131, -1, FALSE, '`Ha_Amapola`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ha_Amapola->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ha_Amapola'] = &$this->Ha_Amapola;

		// Ha_Marihuana
		$this->Ha_Marihuana = new cField('info_diario', 'info_diario', 'x_Ha_Marihuana', 'Ha_Marihuana', '`Ha_Marihuana`', '`Ha_Marihuana`', 131, -1, FALSE, '`Ha_Marihuana`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ha_Marihuana->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ha_Marihuana'] = &$this->Ha_Marihuana;

		// T_erradi
		$this->T_erradi = new cField('info_diario', 'info_diario', 'x_T_erradi', 'T_erradi', '`T_erradi`', '`T_erradi`', 131, -1, FALSE, '`T_erradi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->T_erradi->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['T_erradi'] = &$this->T_erradi;

		// LATITUD_sector
		$this->LATITUD_sector = new cField('info_diario', 'info_diario', 'x_LATITUD_sector', 'LATITUD_sector', '`LATITUD_sector`', '`LATITUD_sector`', 201, -1, FALSE, '`LATITUD_sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['LATITUD_sector'] = &$this->LATITUD_sector;

		// GRA_LAT_Sector
		$this->GRA_LAT_Sector = new cField('info_diario', 'info_diario', 'x_GRA_LAT_Sector', 'GRA_LAT_Sector', '`GRA_LAT_Sector`', '`GRA_LAT_Sector`', 3, -1, FALSE, '`GRA_LAT_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LAT_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LAT_Sector'] = &$this->GRA_LAT_Sector;

		// MIN_LAT_Sector
		$this->MIN_LAT_Sector = new cField('info_diario', 'info_diario', 'x_MIN_LAT_Sector', 'MIN_LAT_Sector', '`MIN_LAT_Sector`', '`MIN_LAT_Sector`', 3, -1, FALSE, '`MIN_LAT_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LAT_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LAT_Sector'] = &$this->MIN_LAT_Sector;

		// SEG_LAT_Sector
		$this->SEG_LAT_Sector = new cField('info_diario', 'info_diario', 'x_SEG_LAT_Sector', 'SEG_LAT_Sector', '`SEG_LAT_Sector`', '`SEG_LAT_Sector`', 131, -1, FALSE, '`SEG_LAT_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LAT_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LAT_Sector'] = &$this->SEG_LAT_Sector;

		// GRA_LONG_Sector
		$this->GRA_LONG_Sector = new cField('info_diario', 'info_diario', 'x_GRA_LONG_Sector', 'GRA_LONG_Sector', '`GRA_LONG_Sector`', '`GRA_LONG_Sector`', 3, -1, FALSE, '`GRA_LONG_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LONG_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LONG_Sector'] = &$this->GRA_LONG_Sector;

		// MIN_LONG_Sector
		$this->MIN_LONG_Sector = new cField('info_diario', 'info_diario', 'x_MIN_LONG_Sector', 'MIN_LONG_Sector', '`MIN_LONG_Sector`', '`MIN_LONG_Sector`', 3, -1, FALSE, '`MIN_LONG_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LONG_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LONG_Sector'] = &$this->MIN_LONG_Sector;

		// SEG_LONG_Sector
		$this->SEG_LONG_Sector = new cField('info_diario', 'info_diario', 'x_SEG_LONG_Sector', 'SEG_LONG_Sector', '`SEG_LONG_Sector`', '`SEG_LONG_Sector`', 131, -1, FALSE, '`SEG_LONG_Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LONG_Sector->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LONG_Sector'] = &$this->SEG_LONG_Sector;

		// Ini_Jorna
		$this->Ini_Jorna = new cField('info_diario', 'info_diario', 'x_Ini_Jorna', 'Ini_Jorna', '`Ini_Jorna`', '`Ini_Jorna`', 200, -1, FALSE, '`Ini_Jorna`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Ini_Jorna'] = &$this->Ini_Jorna;

		// Fin_Jorna
		$this->Fin_Jorna = new cField('info_diario', 'info_diario', 'x_Fin_Jorna', 'Fin_Jorna', '`Fin_Jorna`', '`Fin_Jorna`', 200, -1, FALSE, '`Fin_Jorna`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Fin_Jorna'] = &$this->Fin_Jorna;

		// Situ_Especial
		$this->Situ_Especial = new cField('info_diario', 'info_diario', 'x_Situ_Especial', 'Situ_Especial', '`Situ_Especial`', '`Situ_Especial`', 200, -1, FALSE, '`Situ_Especial`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Situ_Especial'] = &$this->Situ_Especial;

		// Adm_GME
		$this->Adm_GME = new cField('info_diario', 'info_diario', 'x_Adm_GME', 'Adm_GME', '`Adm_GME`', '`Adm_GME`', 131, -1, FALSE, '`Adm_GME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Adm_GME->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Adm_GME'] = &$this->Adm_GME;

		// 1_Abastecimiento
		$this->_1_Abastecimiento = new cField('info_diario', 'info_diario', 'x__1_Abastecimiento', '1_Abastecimiento', '`1_Abastecimiento`', '`1_Abastecimiento`', 131, -1, FALSE, '`1_Abastecimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Acompanamiento_firma_GME = new cField('info_diario', 'info_diario', 'x__1_Acompanamiento_firma_GME', '1_Acompanamiento_firma_GME', '`1_Acompanamiento_firma_GME`', '`1_Acompanamiento_firma_GME`', 131, -1, FALSE, '`1_Acompanamiento_firma_GME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Apoyo_zonal_sin_punto_asignado = new cField('info_diario', 'info_diario', 'x__1_Apoyo_zonal_sin_punto_asignado', '1_Apoyo_zonal_sin_punto_asignado', '`1_Apoyo_zonal_sin_punto_asignado`', '`1_Apoyo_zonal_sin_punto_asignado`', 131, -1, FALSE, '`1_Apoyo_zonal_sin_punto_asignado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Descanso_en_dia_habil = new cField('info_diario', 'info_diario', 'x__1_Descanso_en_dia_habil', '1_Descanso_en_dia_habil', '`1_Descanso_en_dia_habil`', '`1_Descanso_en_dia_habil`', 131, -1, FALSE, '`1_Descanso_en_dia_habil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Descanso_festivo_dominical = new cField('info_diario', 'info_diario', 'x__1_Descanso_festivo_dominical', '1_Descanso_festivo_dominical', '`1_Descanso_festivo_dominical`', '`1_Descanso_festivo_dominical`', 131, -1, FALSE, '`1_Descanso_festivo_dominical`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Dia_compensatorio
		$this->_1_Dia_compensatorio = new cField('info_diario', 'info_diario', 'x__1_Dia_compensatorio', '1_Dia_compensatorio', '`1_Dia_compensatorio`', '`1_Dia_compensatorio`', 131, -1, FALSE, '`1_Dia_compensatorio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Erradicacion_en_dia_festivo = new cField('info_diario', 'info_diario', 'x__1_Erradicacion_en_dia_festivo', '1_Erradicacion_en_dia_festivo', '`1_Erradicacion_en_dia_festivo`', '`1_Erradicacion_en_dia_festivo`', 131, -1, FALSE, '`1_Erradicacion_en_dia_festivo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Espera_helicoptero_Helistar = new cField('info_diario', 'info_diario', 'x__1_Espera_helicoptero_Helistar', '1_Espera_helicoptero_Helistar', '`1_Espera_helicoptero_Helistar`', '`1_Espera_helicoptero_Helistar`', 131, -1, FALSE, '`1_Espera_helicoptero_Helistar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Extraccion
		$this->_1_Extraccion = new cField('info_diario', 'info_diario', 'x__1_Extraccion', '1_Extraccion', '`1_Extraccion`', '`1_Extraccion`', 131, -1, FALSE, '`1_Extraccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Firma_contrato_GME = new cField('info_diario', 'info_diario', 'x__1_Firma_contrato_GME', '1_Firma_contrato_GME', '`1_Firma_contrato_GME`', '`1_Firma_contrato_GME`', 131, -1, FALSE, '`1_Firma_contrato_GME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Induccion_Apoyo_Zonal = new cField('info_diario', 'info_diario', 'x__1_Induccion_Apoyo_Zonal', '1_Induccion_Apoyo_Zonal', '`1_Induccion_Apoyo_Zonal`', '`1_Induccion_Apoyo_Zonal`', 131, -1, FALSE, '`1_Induccion_Apoyo_Zonal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Insercion
		$this->_1_Insercion = new cField('info_diario', 'info_diario', 'x__1_Insercion', '1_Insercion', '`1_Insercion`', '`1_Insercion`', 131, -1, FALSE, '`1_Insercion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Novedad_apoyo_zonal = new cField('info_diario', 'info_diario', 'x__1_Novedad_apoyo_zonal', '1_Novedad_apoyo_zonal', '`1_Novedad_apoyo_zonal`', '`1_Novedad_apoyo_zonal`', 131, -1, FALSE, '`1_Novedad_apoyo_zonal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Novedad_enfermero
		$this->_1_Novedad_enfermero = new cField('info_diario', 'info_diario', 'x__1_Novedad_enfermero', '1_Novedad_enfermero', '`1_Novedad_enfermero`', '`1_Novedad_enfermero`', 131, -1, FALSE, '`1_Novedad_enfermero`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Transporte_bus
		$this->_1_Transporte_bus = new cField('info_diario', 'info_diario', 'x__1_Transporte_bus', '1_Transporte_bus', '`1_Transporte_bus`', '`1_Transporte_bus`', 131, -1, FALSE, '`1_Transporte_bus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Traslado_apoyo_zonal = new cField('info_diario', 'info_diario', 'x__1_Traslado_apoyo_zonal', '1_Traslado_apoyo_zonal', '`1_Traslado_apoyo_zonal`', '`1_Traslado_apoyo_zonal`', 131, -1, FALSE, '`1_Traslado_apoyo_zonal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_1_Traslado_area_vivac = new cField('info_diario', 'info_diario', 'x__1_Traslado_area_vivac', '1_Traslado_area_vivac', '`1_Traslado_area_vivac`', '`1_Traslado_area_vivac`', 131, -1, FALSE, '`1_Traslado_area_vivac`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Adm_Fuerza
		$this->Adm_Fuerza = new cField('info_diario', 'info_diario', 'x_Adm_Fuerza', 'Adm_Fuerza', '`Adm_Fuerza`', '`Adm_Fuerza`', 131, -1, FALSE, '`Adm_Fuerza`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_2_A_la_espera_definicion_nuevo_punto_FP = new cField('info_diario', 'info_diario', 'x__2_A_la_espera_definicion_nuevo_punto_FP', '2_A_la_espera_definicion_nuevo_punto_FP', '`2_A_la_espera_definicion_nuevo_punto_FP`', '`2_A_la_espera_definicion_nuevo_punto_FP`', 131, -1, FALSE, '`2_A_la_espera_definicion_nuevo_punto_FP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_2_Espera_helicoptero_FP_que_abastece = new cField('info_diario', 'info_diario', 'x__2_Espera_helicoptero_FP_que_abastece', '2_Espera_helicoptero_FP_que_abastece', '`2_Espera_helicoptero_FP_que_abastece`', '`2_Espera_helicoptero_FP_que_abastece`', 131, -1, FALSE, '`2_Espera_helicoptero_FP_que_abastece`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 2_Induccion_FP
		$this->_2_Induccion_FP = new cField('info_diario', 'info_diario', 'x__2_Induccion_FP', '2_Induccion_FP', '`2_Induccion_FP`', '`2_Induccion_FP`', 131, -1, FALSE, '`2_Induccion_FP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_2_Problemas_fuerza_publica = new cField('info_diario', 'info_diario', 'x__2_Problemas_fuerza_publica', '2_Problemas_fuerza_publica', '`2_Problemas_fuerza_publica`', '`2_Problemas_fuerza_publica`', 131, -1, FALSE, '`2_Problemas_fuerza_publica`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 2_Sin_seguridad
		$this->_2_Sin_seguridad = new cField('info_diario', 'info_diario', 'x__2_Sin_seguridad', '2_Sin_seguridad', '`2_Sin_seguridad`', '`2_Sin_seguridad`', 131, -1, FALSE, '`2_Sin_seguridad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Sin_seguridad->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['2_Sin_seguridad'] = &$this->_2_Sin_seguridad;

		// Sit_Seguridad
		$this->Sit_Seguridad = new cField('info_diario', 'info_diario', 'x_Sit_Seguridad', 'Sit_Seguridad', '`Sit_Seguridad`', '`Sit_Seguridad`', 131, -1, FALSE, '`Sit_Seguridad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sit_Seguridad->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Sit_Seguridad'] = &$this->Sit_Seguridad;

		// 3_AEI_controlado
		$this->_3_AEI_controlado = new cField('info_diario', 'info_diario', 'x__3_AEI_controlado', '3_AEI_controlado', '`3_AEI_controlado`', '`3_AEI_controlado`', 131, -1, FALSE, '`3_AEI_controlado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 3_AEI_no_controlado
		$this->_3_AEI_no_controlado = new cField('info_diario', 'info_diario', 'x__3_AEI_no_controlado', '3_AEI_no_controlado', '`3_AEI_no_controlado`', '`3_AEI_no_controlado`', 131, -1, FALSE, '`3_AEI_no_controlado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_3_Bloqueo_parcial_de_la_comunidad = new cField('info_diario', 'info_diario', 'x__3_Bloqueo_parcial_de_la_comunidad', '3_Bloqueo_parcial_de_la_comunidad', '`3_Bloqueo_parcial_de_la_comunidad`', '`3_Bloqueo_parcial_de_la_comunidad`', 131, -1, FALSE, '`3_Bloqueo_parcial_de_la_comunidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_3_Bloqueo_total_de_la_comunidad = new cField('info_diario', 'info_diario', 'x__3_Bloqueo_total_de_la_comunidad', '3_Bloqueo_total_de_la_comunidad', '`3_Bloqueo_total_de_la_comunidad`', '`3_Bloqueo_total_de_la_comunidad`', 131, -1, FALSE, '`3_Bloqueo_total_de_la_comunidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 3_Combate
		$this->_3_Combate = new cField('info_diario', 'info_diario', 'x__3_Combate', '3_Combate', '`3_Combate`', '`3_Combate`', 131, -1, FALSE, '`3_Combate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Combate->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['3_Combate'] = &$this->_3_Combate;

		// 3_Hostigamiento
		$this->_3_Hostigamiento = new cField('info_diario', 'info_diario', 'x__3_Hostigamiento', '3_Hostigamiento', '`3_Hostigamiento`', '`3_Hostigamiento`', 131, -1, FALSE, '`3_Hostigamiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Hostigamiento->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['3_Hostigamiento'] = &$this->_3_Hostigamiento;

		// 3_MAP_Controlada
		$this->_3_MAP_Controlada = new cField('info_diario', 'info_diario', 'x__3_MAP_Controlada', '3_MAP_Controlada', '`3_MAP_Controlada`', '`3_MAP_Controlada`', 131, -1, FALSE, '`3_MAP_Controlada`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 3_MAP_No_controlada
		$this->_3_MAP_No_controlada = new cField('info_diario', 'info_diario', 'x__3_MAP_No_controlada', '3_MAP_No_controlada', '`3_MAP_No_controlada`', '`3_MAP_No_controlada`', 131, -1, FALSE, '`3_MAP_No_controlada`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_3_Operaciones_de_seguridad = new cField('info_diario', 'info_diario', 'x__3_Operaciones_de_seguridad', '3_Operaciones_de_seguridad', '`3_Operaciones_de_seguridad`', '`3_Operaciones_de_seguridad`', 131, -1, FALSE, '`3_Operaciones_de_seguridad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// LATITUD_segurid
		$this->LATITUD_segurid = new cField('info_diario', 'info_diario', 'x_LATITUD_segurid', 'LATITUD_segurid', '`LATITUD_segurid`', '`LATITUD_segurid`', 201, -1, FALSE, '`LATITUD_segurid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['LATITUD_segurid'] = &$this->LATITUD_segurid;

		// GRA_LAT_segurid
		$this->GRA_LAT_segurid = new cField('info_diario', 'info_diario', 'x_GRA_LAT_segurid', 'GRA_LAT_segurid', '`GRA_LAT_segurid`', '`GRA_LAT_segurid`', 3, -1, FALSE, '`GRA_LAT_segurid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LAT_segurid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LAT_segurid'] = &$this->GRA_LAT_segurid;

		// MIN_LAT_segurid
		$this->MIN_LAT_segurid = new cField('info_diario', 'info_diario', 'x_MIN_LAT_segurid', 'MIN_LAT_segurid', '`MIN_LAT_segurid`', '`MIN_LAT_segurid`', 3, -1, FALSE, '`MIN_LAT_segurid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LAT_segurid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LAT_segurid'] = &$this->MIN_LAT_segurid;

		// SEG_LAT_segurid
		$this->SEG_LAT_segurid = new cField('info_diario', 'info_diario', 'x_SEG_LAT_segurid', 'SEG_LAT_segurid', '`SEG_LAT_segurid`', '`SEG_LAT_segurid`', 131, -1, FALSE, '`SEG_LAT_segurid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LAT_segurid->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LAT_segurid'] = &$this->SEG_LAT_segurid;

		// GRA_LONG_seguri
		$this->GRA_LONG_seguri = new cField('info_diario', 'info_diario', 'x_GRA_LONG_seguri', 'GRA_LONG_seguri', '`GRA_LONG_seguri`', '`GRA_LONG_seguri`', 3, -1, FALSE, '`GRA_LONG_seguri`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LONG_seguri->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LONG_seguri'] = &$this->GRA_LONG_seguri;

		// MIN_LONG_seguri
		$this->MIN_LONG_seguri = new cField('info_diario', 'info_diario', 'x_MIN_LONG_seguri', 'MIN_LONG_seguri', '`MIN_LONG_seguri`', '`MIN_LONG_seguri`', 3, -1, FALSE, '`MIN_LONG_seguri`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LONG_seguri->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LONG_seguri'] = &$this->MIN_LONG_seguri;

		// SEG_LONG_seguri
		$this->SEG_LONG_seguri = new cField('info_diario', 'info_diario', 'x_SEG_LONG_seguri', 'SEG_LONG_seguri', '`SEG_LONG_seguri`', '`SEG_LONG_seguri`', 131, -1, FALSE, '`SEG_LONG_seguri`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LONG_seguri->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LONG_seguri'] = &$this->SEG_LONG_seguri;

		// Novedad
		$this->Novedad = new cField('info_diario', 'info_diario', 'x_Novedad', 'Novedad', '`Novedad`', '`Novedad`', 131, -1, FALSE, '`Novedad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Novedad->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Novedad'] = &$this->Novedad;

		// 4_Epidemia
		$this->_4_Epidemia = new cField('info_diario', 'info_diario', 'x__4_Epidemia', '4_Epidemia', '`4_Epidemia`', '`4_Epidemia`', 131, -1, FALSE, '`4_Epidemia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_4_Novedad_climatologica = new cField('info_diario', 'info_diario', 'x__4_Novedad_climatologica', '4_Novedad_climatologica', '`4_Novedad_climatologica`', '`4_Novedad_climatologica`', 131, -1, FALSE, '`4_Novedad_climatologica`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_4_Registro_de_cultivos = new cField('info_diario', 'info_diario', 'x__4_Registro_de_cultivos', '4_Registro_de_cultivos', '`4_Registro_de_cultivos`', '`4_Registro_de_cultivos`', 131, -1, FALSE, '`4_Registro_de_cultivos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_4_Zona_con_cultivos_muy_dispersos = new cField('info_diario', 'info_diario', 'x__4_Zona_con_cultivos_muy_dispersos', '4_Zona_con_cultivos_muy_dispersos', '`4_Zona_con_cultivos_muy_dispersos`', '`4_Zona_con_cultivos_muy_dispersos`', 131, -1, FALSE, '`4_Zona_con_cultivos_muy_dispersos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->_4_Zona_de_cruce_de_rios_caudalosos = new cField('info_diario', 'info_diario', 'x__4_Zona_de_cruce_de_rios_caudalosos', '4_Zona_de_cruce_de_rios_caudalosos', '`4_Zona_de_cruce_de_rios_caudalosos`', '`4_Zona_de_cruce_de_rios_caudalosos`', 131, -1, FALSE, '`4_Zona_de_cruce_de_rios_caudalosos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 4_Zona_sin_cultivos
		$this->_4_Zona_sin_cultivos = new cField('info_diario', 'info_diario', 'x__4_Zona_sin_cultivos', '4_Zona_sin_cultivos', '`4_Zona_sin_cultivos`', '`4_Zona_sin_cultivos`', 131, -1, FALSE, '`4_Zona_sin_cultivos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Num_Erra_Salen
		$this->Num_Erra_Salen = new cField('info_diario', 'info_diario', 'x_Num_Erra_Salen', 'Num_Erra_Salen', '`Num_Erra_Salen`', '`Num_Erra_Salen`', 3, -1, FALSE, '`Num_Erra_Salen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Num_Erra_Salen->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Num_Erra_Salen'] = &$this->Num_Erra_Salen;

		// Num_Erra_Quedan
		$this->Num_Erra_Quedan = new cField('info_diario', 'info_diario', 'x_Num_Erra_Quedan', 'Num_Erra_Quedan', '`Num_Erra_Quedan`', '`Num_Erra_Quedan`', 3, -1, FALSE, '`Num_Erra_Quedan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Num_Erra_Quedan->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Num_Erra_Quedan'] = &$this->Num_Erra_Quedan;

		// No_ENFERMERO
		$this->No_ENFERMERO = new cField('info_diario', 'info_diario', 'x_No_ENFERMERO', 'No_ENFERMERO', '`No_ENFERMERO`', '`No_ENFERMERO`', 200, -1, FALSE, '`No_ENFERMERO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['No_ENFERMERO'] = &$this->No_ENFERMERO;

		// NUM_FP
		$this->NUM_FP = new cField('info_diario', 'info_diario', 'x_NUM_FP', 'NUM_FP', '`NUM_FP`', '`NUM_FP`', 3, -1, FALSE, '`NUM_FP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NUM_FP->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NUM_FP'] = &$this->NUM_FP;

		// NUM_Perso_EVA
		$this->NUM_Perso_EVA = new cField('info_diario', 'info_diario', 'x_NUM_Perso_EVA', 'NUM_Perso_EVA', '`NUM_Perso_EVA`', '`NUM_Perso_EVA`', 3, -1, FALSE, '`NUM_Perso_EVA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NUM_Perso_EVA->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NUM_Perso_EVA'] = &$this->NUM_Perso_EVA;

		// NUM_Poli
		$this->NUM_Poli = new cField('info_diario', 'info_diario', 'x_NUM_Poli', 'NUM_Poli', '`NUM_Poli`', '`NUM_Poli`', 3, -1, FALSE, '`NUM_Poli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NUM_Poli->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NUM_Poli'] = &$this->NUM_Poli;

		// TEMA
		$this->TEMA = new cField('info_diario', 'info_diario', 'x_TEMA', 'TEMA', '`TEMA`', '`TEMA`', 201, -1, FALSE, '`TEMA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TEMA'] = &$this->TEMA;

		// Otro_Tema
		$this->Otro_Tema = new cField('info_diario', 'info_diario', 'x_Otro_Tema', 'Otro_Tema', '`Otro_Tema`', '`Otro_Tema`', 200, -1, FALSE, '`Otro_Tema`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_Tema'] = &$this->Otro_Tema;

		// OBSERVACION
		$this->OBSERVACION = new cField('info_diario', 'info_diario', 'x_OBSERVACION', 'OBSERVACION', '`OBSERVACION`', '`OBSERVACION`', 201, -1, FALSE, '`OBSERVACION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBSERVACION'] = &$this->OBSERVACION;

		// AÑO
		$this->AD1O = new cField('info_diario', 'info_diario', 'x_AD1O', 'AÑO', '`AÑO`', '`AÑO`', 200, -1, FALSE, '`AÑO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['AÑO'] = &$this->AD1O;

		// FASE
		$this->FASE = new cField('info_diario', 'info_diario', 'x_FASE', 'FASE', '`FASE`', '`FASE`', 200, -1, FALSE, '`FASE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FASE'] = &$this->FASE;

		// F_Sincron
		$this->F_Sincron = new cField('info_diario', 'info_diario', 'x_F_Sincron', 'F_Sincron', '`F_Sincron`', 'DATE_FORMAT(`F_Sincron`, \'%d/%m/%Y\')', 135, 7, FALSE, '`F_Sincron`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->F_Sincron->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['F_Sincron'] = &$this->F_Sincron;

		// FUERZA
		$this->FUERZA = new cField('info_diario', 'info_diario', 'x_FUERZA', 'FUERZA', '`FUERZA`', '`FUERZA`', 201, -1, FALSE, '`FUERZA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`info_diario`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("info_diarioview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("info_diarioview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "info_diarioadd.php?" . $this->UrlParm($parm);
		else
			return "info_diarioadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("info_diarioedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("info_diarioadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("info_diariodelete.php", $this->UrlParm());
	}
