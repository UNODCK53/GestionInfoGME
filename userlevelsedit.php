...
// Form object
var fuserlevelsedit = new ew_Form("fuserlevelsedit");
...
?>
<form name="fuserlevelsedit" id="fuserlevelsedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" value="<?php echo ew_HtmlEncode($userlevels->userlevelid->CurrentValue) ?>">
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<div id="r_userlevelname" class="form-group">
		<label id="elh_userlevels_userlevelname" for="x_userlevelname" class="col-sm-2 control-label ewLabel"><?php echo $userlevels->userlevelname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
