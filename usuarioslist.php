...
class cusuarios_list extends cusuarios {
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Entidad, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->Cargo, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->Correo, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->rol, $bCtrl); // rol
			$this->UpdateSort($this->Entidad, $bCtrl); // Entidad
...
fusuarioslist.Lists["x_rol"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php
	...
	if ($usuarios->CurrentAction == "" && $usuarios_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$usuarios_list->setWarningMessage($Language->Phrase("NoPermission"));
...
// Header row
$usuarios->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($usuarios->usuario->Visible) { // usuario ?>
	...
	<?php } else { ?>
		<th data-name="usuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->usuario) ?>',2);"><div id="elh_usuarios_usuario" class="usuarios_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->usuario->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->password->Visible) { // password ?>
	...
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->password) ?>',2);"><div id="elh_usuarios_password" class="usuarios_password">
...
<?php if ($usuarios->Nombre->Visible) { // Nombre ?>
	...
	<?php } else { ?>
		<th data-name="Nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Nombre) ?>',2);"><div id="elh_usuarios_Nombre" class="usuarios_Nombre">
...
<?php if ($usuarios->rol->Visible) { // rol ?>
	<?php if ($usuarios->SortUrl($usuarios->rol) == "") { ?>
		<th data-name="rol"><div id="elh_usuarios_rol" class="usuarios_rol"><div class="ewTableHeaderCaption"><?php echo $usuarios->rol->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="rol"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->rol) ?>',2);"><div id="elh_usuarios_rol" class="usuarios_rol">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->rol->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->rol->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->rol->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->Entidad->Visible) { // Entidad ?>
	<?php if ($usuarios->SortUrl($usuarios->Entidad) == "") { ?>
		<th data-name="Entidad"><div id="elh_usuarios_Entidad" class="usuarios_Entidad"><div class="ewTableHeaderCaption"><?php echo $usuarios->Entidad->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Entidad"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Entidad) ?>',2);"><div id="elh_usuarios_Entidad" class="usuarios_Entidad">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Entidad->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Entidad->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Entidad->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->Cargo->Visible) { // Cargo ?>
	<?php if ($usuarios->SortUrl($usuarios->Cargo) == "") { ?>
		<th data-name="Cargo"><div id="elh_usuarios_Cargo" class="usuarios_Cargo"><div class="ewTableHeaderCaption"><?php echo $usuarios->Cargo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Cargo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Cargo) ?>',2);"><div id="elh_usuarios_Cargo" class="usuarios_Cargo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Cargo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Cargo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Cargo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->Correo->Visible) { // Correo ?>
	<?php if ($usuarios->SortUrl($usuarios->Correo) == "") { ?>
		<th data-name="Correo"><div id="elh_usuarios_Correo" class="usuarios_Correo"><div class="ewTableHeaderCaption"><?php echo $usuarios->Correo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Correo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Correo) ?>',2);"><div id="elh_usuarios_Correo" class="usuarios_Correo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Correo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Correo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Correo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
