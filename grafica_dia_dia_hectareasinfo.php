...
$grafica_dia_dia_hectareas = NULL;

//
// Table class for grafica_dia_dia_hectareas
//
class cgrafica_dia_dia_hectareas extends cTable {
	var $Punto;
	var $Fecha;
	...
	function __construct() {
		...
		$this->TableVar = 'grafica_dia_dia_hectareas';
		$this->TableName = 'grafica_dia_dia_hectareas';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Punto
		$this->Punto = new cField('grafica_dia_dia_hectareas', 'grafica_dia_dia_hectareas', 'x_Punto', 'Punto', '`Punto`', '`Punto`', 201, -1, FALSE, '`Punto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Punto'] = &$this->Punto;

		// Fecha
		$this->Fecha = new cField('grafica_dia_dia_hectareas', 'grafica_dia_dia_hectareas', 'x_Fecha', 'Fecha', '`Fecha`', '`Fecha`', 200, -1, FALSE, '`Fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Fecha'] = &$this->Fecha;

		// Total_erradicado
		$this->Total_erradicado = new cField('grafica_dia_dia_hectareas', 'grafica_dia_dia_hectareas', 'x_Total_erradicado', 'Total_erradicado', '`Total_erradicado`', '`Total_erradicado`', 131, -1, FALSE, '`Total_erradicado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`grafica_dia_dia_hectareas`";
	}
	...
	// Update Table
	var $UpdateTable = "`grafica_dia_dia_hectareas`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "grafica_dia_dia_hectareaslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("grafica_dia_dia_hectareasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("grafica_dia_dia_hectareasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "grafica_dia_dia_hectareasadd.php?" . $this->UrlParm($parm);
		else
			return "grafica_dia_dia_hectareasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("grafica_dia_dia_hectareasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("grafica_dia_dia_hectareasadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("grafica_dia_dia_hectareasdelete.php", $this->UrlParm());
	}
