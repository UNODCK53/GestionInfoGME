...
//
// Table class for view_cav
//
class cview_cav extends cTable {
	var $llave;
	var $F_Sincron;
	var $USUARIO;
	var $Cargo_gme;
	...
	function __construct() {
		...
		$this->TableVar = 'view_cav';
		$this->TableName = 'view_cav';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// llave
		$this->llave = new cField('view_cav', 'view_cav', 'x_llave', 'llave', '`llave`', '`llave`', 200, -1, FALSE, '`llave`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['llave'] = &$this->llave;

		// F_Sincron
		$this->F_Sincron = new cField('view_cav', 'view_cav', 'x_F_Sincron', 'F_Sincron', '`F_Sincron`', 'DATE_FORMAT(`F_Sincron`, \'%d/%m/%Y\')', 135, 7, FALSE, '`F_Sincron`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->F_Sincron->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['F_Sincron'] = &$this->F_Sincron;

		// USUARIO
		$this->USUARIO = new cField('view_cav', 'view_cav', 'x_USUARIO', 'USUARIO', '`USUARIO`', '`USUARIO`', 201, -1, FALSE, '`USUARIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['USUARIO'] = &$this->USUARIO;

		// Cargo_gme
		$this->Cargo_gme = new cField('view_cav', 'view_cav', 'x_Cargo_gme', 'Cargo_gme', '`Cargo_gme`', '`Cargo_gme`', 200, -1, FALSE, '`Cargo_gme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cargo_gme'] = &$this->Cargo_gme;

		// Num_AV
		$this->Num_AV = new cField('view_cav', 'view_cav', 'x_Num_AV', 'Num_AV', '`Num_AV`', '`Num_AV`', 200, -1, FALSE, '`Num_AV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_AV'] = &$this->Num_AV;

		// NOM_APOYO
		$this->NOM_APOYO = new cField('view_cav', 'view_cav', 'x_NOM_APOYO', 'NOM_APOYO', '`NOM_APOYO`', '`NOM_APOYO`', 201, -1, FALSE, '`NOM_APOYO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_APOYO'] = &$this->NOM_APOYO;

		// Otro_Nom_Apoyo
		$this->Otro_Nom_Apoyo = new cField('view_cav', 'view_cav', 'x_Otro_Nom_Apoyo', 'Otro_Nom_Apoyo', '`Otro_Nom_Apoyo`', '`Otro_Nom_Apoyo`', 200, -1, FALSE, '`Otro_Nom_Apoyo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_Nom_Apoyo'] = &$this->Otro_Nom_Apoyo;

		// Otro_CC_Apoyo
		$this->Otro_CC_Apoyo = new cField('view_cav', 'view_cav', 'x_Otro_CC_Apoyo', 'Otro_CC_Apoyo', '`Otro_CC_Apoyo`', '`Otro_CC_Apoyo`', 200, -1, FALSE, '`Otro_CC_Apoyo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Otro_PE
		$this->Otro_PE = new cField('view_cav', 'view_cav', 'x_Otro_PE', 'Otro_PE', '`Otro_PE`', '`Otro_PE`', 200, -1, FALSE, '`Otro_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_PE'] = &$this->Otro_PE;

		// Departamento
		$this->Departamento = new cField('view_cav', 'view_cav', 'x_Departamento', 'Departamento', '`Departamento`', '`Departamento`', 200, -1, FALSE, '`Departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Departamento'] = &$this->Departamento;

		// Muncipio
		$this->Muncipio = new cField('view_cav', 'view_cav', 'x_Muncipio', 'Muncipio', '`Muncipio`', '`Muncipio`', 201, -1, FALSE, '`Muncipio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Muncipio'] = &$this->Muncipio;

		// NOM_VDA
		$this->NOM_VDA = new cField('view_cav', 'view_cav', 'x_NOM_VDA', 'NOM_VDA', '`NOM_VDA`', '`NOM_VDA`', 200, -1, FALSE, '`NOM_VDA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_VDA'] = &$this->NOM_VDA;

		// NO_E
		$this->NO_E = new cField('view_cav', 'view_cav', 'x_NO_E', 'NO_E', '`NO_E`', '`NO_E`', 3, -1, FALSE, '`NO_E`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_E->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_E'] = &$this->NO_E;

		// NO_OF
		$this->NO_OF = new cField('view_cav', 'view_cav', 'x_NO_OF', 'NO_OF', '`NO_OF`', '`NO_OF`', 3, -1, FALSE, '`NO_OF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_OF->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_OF'] = &$this->NO_OF;

		// NO_SUBOF
		$this->NO_SUBOF = new cField('view_cav', 'view_cav', 'x_NO_SUBOF', 'NO_SUBOF', '`NO_SUBOF`', '`NO_SUBOF`', 3, -1, FALSE, '`NO_SUBOF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_SUBOF->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_SUBOF'] = &$this->NO_SUBOF;

		// NO_SOL
		$this->NO_SOL = new cField('view_cav', 'view_cav', 'x_NO_SOL', 'NO_SOL', '`NO_SOL`', '`NO_SOL`', 3, -1, FALSE, '`NO_SOL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_SOL->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_SOL'] = &$this->NO_SOL;

		// NO_PATRU
		$this->NO_PATRU = new cField('view_cav', 'view_cav', 'x_NO_PATRU', 'NO_PATRU', '`NO_PATRU`', '`NO_PATRU`', 3, -1, FALSE, '`NO_PATRU`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_PATRU->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_PATRU'] = &$this->NO_PATRU;

		// Nom_enfer
		$this->Nom_enfer = new cField('view_cav', 'view_cav', 'x_Nom_enfer', 'Nom_enfer', '`Nom_enfer`', '`Nom_enfer`', 201, -1, FALSE, '`Nom_enfer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nom_enfer'] = &$this->Nom_enfer;

		// Otro_Nom_Enfer
		$this->Otro_Nom_Enfer = new cField('view_cav', 'view_cav', 'x_Otro_Nom_Enfer', 'Otro_Nom_Enfer', '`Otro_Nom_Enfer`', '`Otro_Nom_Enfer`', 200, -1, FALSE, '`Otro_Nom_Enfer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_Nom_Enfer'] = &$this->Otro_Nom_Enfer;

		// Otro_CC_Enfer
		$this->Otro_CC_Enfer = new cField('view_cav', 'view_cav', 'x_Otro_CC_Enfer', 'Otro_CC_Enfer', '`Otro_CC_Enfer`', '`Otro_CC_Enfer`', 200, -1, FALSE, '`Otro_CC_Enfer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_CC_Enfer'] = &$this->Otro_CC_Enfer;

		// Armada
		$this->Armada = new cField('view_cav', 'view_cav', 'x_Armada', 'Armada', '`Armada`', '`Armada`', 131, -1, FALSE, '`Armada`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Armada->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Armada'] = &$this->Armada;

		// Ejercito
		$this->Ejercito = new cField('view_cav', 'view_cav', 'x_Ejercito', 'Ejercito', '`Ejercito`', '`Ejercito`', 131, -1, FALSE, '`Ejercito`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ejercito->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ejercito'] = &$this->Ejercito;

		// Policia
		$this->Policia = new cField('view_cav', 'view_cav', 'x_Policia', 'Policia', '`Policia`', '`Policia`', 131, -1, FALSE, '`Policia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Policia->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Policia'] = &$this->Policia;

		// NOM_UNIDAD
		$this->NOM_UNIDAD = new cField('view_cav', 'view_cav', 'x_NOM_UNIDAD', 'NOM_UNIDAD', '`NOM_UNIDAD`', '`NOM_UNIDAD`', 200, -1, FALSE, '`NOM_UNIDAD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_UNIDAD'] = &$this->NOM_UNIDAD;

		// NOM_COMAN
		$this->NOM_COMAN = new cField('view_cav', 'view_cav', 'x_NOM_COMAN', 'NOM_COMAN', '`NOM_COMAN`', '`NOM_COMAN`', 200, -1, FALSE, '`NOM_COMAN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_COMAN'] = &$this->NOM_COMAN;

		// CC_COMAN
		$this->CC_COMAN = new cField('view_cav', 'view_cav', 'x_CC_COMAN', 'CC_COMAN', '`CC_COMAN`', '`CC_COMAN`', 200, -1, FALSE, '`CC_COMAN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CC_COMAN'] = &$this->CC_COMAN;

		// TEL_COMAN
		$this->TEL_COMAN = new cField('view_cav', 'view_cav', 'x_TEL_COMAN', 'TEL_COMAN', '`TEL_COMAN`', '`TEL_COMAN`', 200, -1, FALSE, '`TEL_COMAN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TEL_COMAN'] = &$this->TEL_COMAN;

		// RANGO_COMAN
		$this->RANGO_COMAN = new cField('view_cav', 'view_cav', 'x_RANGO_COMAN', 'RANGO_COMAN', '`RANGO_COMAN`', '`RANGO_COMAN`', 201, -1, FALSE, '`RANGO_COMAN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['RANGO_COMAN'] = &$this->RANGO_COMAN;

		// Otro_rango
		$this->Otro_rango = new cField('view_cav', 'view_cav', 'x_Otro_rango', 'Otro_rango', '`Otro_rango`', '`Otro_rango`', 200, -1, FALSE, '`Otro_rango`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_rango'] = &$this->Otro_rango;

		// NO_GDETECCION
		$this->NO_GDETECCION = new cField('view_cav', 'view_cav', 'x_NO_GDETECCION', 'NO_GDETECCION', '`NO_GDETECCION`', '`NO_GDETECCION`', 3, -1, FALSE, '`NO_GDETECCION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->NO_GDETECCION->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['NO_GDETECCION'] = &$this->NO_GDETECCION;

		// NO_BINOMIO
		$this->NO_BINOMIO = new cField('view_cav', 'view_cav', 'x_NO_BINOMIO', 'NO_BINOMIO', '`NO_BINOMIO`', '`NO_BINOMIO`', 3, -1, FALSE, '`NO_BINOMIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// DIA
		$this->DIA = new cField('view_cav', 'view_cav', 'x_DIA', 'DIA', '`DIA`', '`DIA`', 200, -1, FALSE, '`DIA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['DIA'] = &$this->DIA;

		// MES
		$this->MES = new cField('view_cav', 'view_cav', 'x_MES', 'MES', '`MES`', '`MES`', 200, -1, FALSE, '`MES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MES'] = &$this->MES;

		// LATITUD
		$this->LATITUD = new cField('view_cav', 'view_cav', 'x_LATITUD', 'LATITUD', '`LATITUD`', '`LATITUD`', 201, -1, FALSE, '`LATITUD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['LATITUD'] = &$this->LATITUD;

		// GRA_LAT
		$this->GRA_LAT = new cField('view_cav', 'view_cav', 'x_GRA_LAT', 'GRA_LAT', '`GRA_LAT`', '`GRA_LAT`', 3, -1, FALSE, '`GRA_LAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LAT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LAT'] = &$this->GRA_LAT;

		// MIN_LAT
		$this->MIN_LAT = new cField('view_cav', 'view_cav', 'x_MIN_LAT', 'MIN_LAT', '`MIN_LAT`', '`MIN_LAT`', 3, -1, FALSE, '`MIN_LAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LAT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LAT'] = &$this->MIN_LAT;

		// SEG_LAT
		$this->SEG_LAT = new cField('view_cav', 'view_cav', 'x_SEG_LAT', 'SEG_LAT', '`SEG_LAT`', '`SEG_LAT`', 131, -1, FALSE, '`SEG_LAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LAT->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LAT'] = &$this->SEG_LAT;

		// GRA_LONG
		$this->GRA_LONG = new cField('view_cav', 'view_cav', 'x_GRA_LONG', 'GRA_LONG', '`GRA_LONG`', '`GRA_LONG`', 3, -1, FALSE, '`GRA_LONG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->GRA_LONG->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['GRA_LONG'] = &$this->GRA_LONG;

		// MIN_LONG
		$this->MIN_LONG = new cField('view_cav', 'view_cav', 'x_MIN_LONG', 'MIN_LONG', '`MIN_LONG`', '`MIN_LONG`', 3, -1, FALSE, '`MIN_LONG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MIN_LONG->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MIN_LONG'] = &$this->MIN_LONG;

		// SEG_LONG
		$this->SEG_LONG = new cField('view_cav', 'view_cav', 'x_SEG_LONG', 'SEG_LONG', '`SEG_LONG`', '`SEG_LONG`', 131, -1, FALSE, '`SEG_LONG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->SEG_LONG->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SEG_LONG'] = &$this->SEG_LONG;

		// OBSERVACION
		$this->OBSERVACION = new cField('view_cav', 'view_cav', 'x_OBSERVACION', 'OBSERVACION', '`OBSERVACION`', '`OBSERVACION`', 201, -1, FALSE, '`OBSERVACION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBSERVACION'] = &$this->OBSERVACION;

		// AÑO
		$this->AD1O = new cField('view_cav', 'view_cav', 'x_AD1O', 'AÑO', '`AÑO`', '`AÑO`', 200, -1, FALSE, '`AÑO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['AÑO'] = &$this->AD1O;

		// FASE
		$this->FASE = new cField('view_cav', 'view_cav', 'x_FASE', 'FASE', '`FASE`', '`FASE`', 200, -1, FALSE, '`FASE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FASE'] = &$this->FASE;

		// Modificado
		$this->Modificado = new cField('view_cav', 'view_cav', 'x_Modificado', 'Modificado', '`Modificado`', '`Modificado`', 200, -1, FALSE, '`Modificado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_cav`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_cavview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_cavview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_cavadd.php?" . $this->UrlParm($parm);
		else
			return "view_cavadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_cavedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_cavadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_cavdelete.php", $this->UrlParm());
	}
