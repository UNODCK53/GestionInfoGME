...
<p class="form-control-static"><?php echo $view_e_y_n->NOM_GE->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_NOM_GE" name="x_NOM_GE" id="x_NOM_GE" value="<?php echo ew_HtmlEncode($view_e_y_n->NOM_GE->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Otro_PGE->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Otro_PGE" name="x_Otro_PGE" id="x_Otro_PGE" value="<?php echo ew_HtmlEncode($view_e_y_n->Otro_PGE->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Otro_CC_PGE->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Otro_CC_PGE" name="x_Otro_CC_PGE" id="x_Otro_CC_PGE" value="<?php echo ew_HtmlEncode($view_e_y_n->Otro_CC_PGE->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->TIPO_INFORME->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_TIPO_INFORME" name="x_TIPO_INFORME" id="x_TIPO_INFORME" value="<?php echo ew_HtmlEncode($view_e_y_n->TIPO_INFORME->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->FECHA_NOVEDAD->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_FECHA_NOVEDAD" name="x_FECHA_NOVEDAD" id="x_FECHA_NOVEDAD" value="<?php echo ew_HtmlEncode($view_e_y_n->FECHA_NOVEDAD->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->DIA->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_DIA" name="x_DIA" id="x_DIA" value="<?php echo ew_HtmlEncode($view_e_y_n->DIA->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->MES->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_MES" name="x_MES" id="x_MES" value="<?php echo ew_HtmlEncode($view_e_y_n->MES->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Num_Evacua->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Num_Evacua" name="x_Num_Evacua" id="x_Num_Evacua" value="<?php echo ew_HtmlEncode($view_e_y_n->Num_Evacua->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->PTO_INCOMU->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_PTO_INCOMU" name="x_PTO_INCOMU" id="x_PTO_INCOMU" value="<?php echo ew_HtmlEncode($view_e_y_n->PTO_INCOMU->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->OBS_punt_inco->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_OBS_punt_inco" name="x_OBS_punt_inco" id="x_OBS_punt_inco" value="<?php echo ew_HtmlEncode($view_e_y_n->OBS_punt_inco->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->NUM_Novedad->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_NUM_Novedad" name="x_NUM_Novedad" id="x_NUM_Novedad" value="<?php echo ew_HtmlEncode($view_e_y_n->NUM_Novedad->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Nom_Per_Evacu->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Nom_Per_Evacu" name="x_Nom_Per_Evacu" id="x_Nom_Per_Evacu" value="<?php echo ew_HtmlEncode($view_e_y_n->Nom_Per_Evacu->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Nom_Otro_Per_Evacu->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Nom_Otro_Per_Evacu" name="x_Nom_Otro_Per_Evacu" id="x_Nom_Otro_Per_Evacu" value="<?php echo ew_HtmlEncode($view_e_y_n->Nom_Otro_Per_Evacu->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->CC_Otro_Per_Evacu->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_CC_Otro_Per_Evacu" name="x_CC_Otro_Per_Evacu" id="x_CC_Otro_Per_Evacu" value="<?php echo ew_HtmlEncode($view_e_y_n->CC_Otro_Per_Evacu->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Cargo_Per_EVA->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Cargo_Per_EVA" name="x_Cargo_Per_EVA" id="x_Cargo_Per_EVA" value="<?php echo ew_HtmlEncode($view_e_y_n->Cargo_Per_EVA->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Motivo_Eva->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Motivo_Eva" name="x_Motivo_Eva" id="x_Motivo_Eva" value="<?php echo ew_HtmlEncode($view_e_y_n->Motivo_Eva->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->NOM_PE->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_NOM_PE" name="x_NOM_PE" id="x_NOM_PE" value="<?php echo ew_HtmlEncode($view_e_y_n->NOM_PE->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Otro_Nom_PE->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Otro_Nom_PE" name="x_Otro_Nom_PE" id="x_Otro_Nom_PE" value="<?php echo ew_HtmlEncode($view_e_y_n->Otro_Nom_PE->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->NOM_CAPATAZ->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_NOM_CAPATAZ" name="x_NOM_CAPATAZ" id="x_NOM_CAPATAZ" value="<?php echo ew_HtmlEncode($view_e_y_n->NOM_CAPATAZ->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Otro_Nom_Capata->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Otro_Nom_Capata" name="x_Otro_Nom_Capata" id="x_Otro_Nom_Capata" value="<?php echo ew_HtmlEncode($view_e_y_n->Otro_Nom_Capata->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Otro_CC_Capata->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Otro_CC_Capata" name="x_Otro_CC_Capata" id="x_Otro_CC_Capata" value="<?php echo ew_HtmlEncode($view_e_y_n->Otro_CC_Capata->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Muncipio->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Muncipio" name="x_Muncipio" id="x_Muncipio" value="<?php echo ew_HtmlEncode($view_e_y_n->Muncipio->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Departamento->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Departamento" name="x_Departamento" id="x_Departamento" value="<?php echo ew_HtmlEncode($view_e_y_n->Departamento->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->F_llegada->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_F_llegada" name="x_F_llegada" id="x_F_llegada" value="<?php echo ew_HtmlEncode($view_e_y_n->F_llegada->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $view_e_y_n->Fecha->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Fecha" name="x_Fecha" id="x_Fecha" value="<?php echo ew_HtmlEncode($view_e_y_n->Fecha->CurrentValue) ?>">
...
<input type="text" data-field="x_Modificado" name="x_Modificado" id="x_Modificado" size="30" maxlength="2" placeholder="<?php echo ew_HtmlEncode($view_e_y_n->Modificado->PlaceHolder) ?>" value="<?php echo $view_e_y_n->Modificado->EditValue ?>"<?php echo $view_e_y_n->Modificado->EditAttributes() ?>>
</span>
