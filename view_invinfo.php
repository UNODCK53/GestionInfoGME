...
//
// Table class for view_inv
//
class cview_inv extends cTable {
	var $llave;
	var $F_Sincron;
	var $USUARIO;
	var $Cargo_gme;
	...
	function __construct() {
		...
		$this->TableVar = 'view_inv';
		$this->TableName = 'view_inv';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// llave
		$this->llave = new cField('view_inv', 'view_inv', 'x_llave', 'llave', '`llave`', '`llave`', 200, -1, FALSE, '`llave`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// USUARIO
		$this->USUARIO = new cField('view_inv', 'view_inv', 'x_USUARIO', 'USUARIO', '`USUARIO`', '`USUARIO`', 201, -1, FALSE, '`USUARIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['USUARIO'] = &$this->USUARIO;

		// Cargo_gme
		$this->Cargo_gme = new cField('view_inv', 'view_inv', 'x_Cargo_gme', 'Cargo_gme', '`Cargo_gme`', '`Cargo_gme`', 200, -1, FALSE, '`Cargo_gme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cargo_gme'] = &$this->Cargo_gme;

		// NOM_PE
		$this->NOM_PE = new cField('view_inv', 'view_inv', 'x_NOM_PE', 'NOM_PE', '`NOM_PE`', '`NOM_PE`', 200, -1, FALSE, '`NOM_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_PE'] = &$this->NOM_PE;

		// Otro_PE
		$this->Otro_PE = new cField('view_inv', 'view_inv', 'x_Otro_PE', 'Otro_PE', '`Otro_PE`', '`Otro_PE`', 200, -1, FALSE, '`Otro_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_PE'] = &$this->Otro_PE;

		// DIA
		$this->DIA = new cField('view_inv', 'view_inv', 'x_DIA', 'DIA', '`DIA`', '`DIA`', 200, -1, FALSE, '`DIA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['DIA'] = &$this->DIA;

		// MES
		$this->MES = new cField('view_inv', 'view_inv', 'x_MES', 'MES', '`MES`', '`MES`', 200, -1, FALSE, '`MES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MES'] = &$this->MES;

		// OBSERVACION
		$this->OBSERVACION = new cField('view_inv', 'view_inv', 'x_OBSERVACION', 'OBSERVACION', '`OBSERVACION`', '`OBSERVACION`', 201, -1, FALSE, '`OBSERVACION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBSERVACION'] = &$this->OBSERVACION;

		// AÑO
		$this->AD1O = new cField('view_inv', 'view_inv', 'x_AD1O', 'AÑO', '`AÑO`', '`AÑO`', 200, -1, FALSE, '`AÑO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['AÑO'] = &$this->AD1O;

		// FASE
		$this->FASE = new cField('view_inv', 'view_inv', 'x_FASE', 'FASE', '`FASE`', '`FASE`', 200, -1, FALSE, '`FASE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// TIPO_INV
		$this->TIPO_INV = new cField('view_inv', 'view_inv', 'x_TIPO_INV', 'TIPO_INV', '`TIPO_INV`', '`TIPO_INV`', 201, -1, FALSE, '`TIPO_INV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TIPO_INV'] = &$this->TIPO_INV;

		// NOM_CAPATAZ
		$this->NOM_CAPATAZ = new cField('view_inv', 'view_inv', 'x_NOM_CAPATAZ', 'NOM_CAPATAZ', '`NOM_CAPATAZ`', '`NOM_CAPATAZ`', 201, -1, FALSE, '`NOM_CAPATAZ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_CAPATAZ'] = &$this->NOM_CAPATAZ;

		// Otro_NOM_CAPAT
		$this->Otro_NOM_CAPAT = new cField('view_inv', 'view_inv', 'x_Otro_NOM_CAPAT', 'Otro_NOM_CAPAT', '`Otro_NOM_CAPAT`', '`Otro_NOM_CAPAT`', 200, -1, FALSE, '`Otro_NOM_CAPAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_NOM_CAPAT'] = &$this->Otro_NOM_CAPAT;

		// Otro_CC_CAPAT
		$this->Otro_CC_CAPAT = new cField('view_inv', 'view_inv', 'x_Otro_CC_CAPAT', 'Otro_CC_CAPAT', '`Otro_CC_CAPAT`', '`Otro_CC_CAPAT`', 200, -1, FALSE, '`Otro_CC_CAPAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_CC_CAPAT'] = &$this->Otro_CC_CAPAT;

		// NOM_LUGAR
		$this->NOM_LUGAR = new cField('view_inv', 'view_inv', 'x_NOM_LUGAR', 'NOM_LUGAR', '`NOM_LUGAR`', '`NOM_LUGAR`', 200, -1, FALSE, '`NOM_LUGAR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_LUGAR'] = &$this->NOM_LUGAR;

		// Cocina
		$this->Cocina = new cField('view_inv', 'view_inv', 'x_Cocina', 'Cocina', '`Cocina`', '`Cocina`', 131, -1, FALSE, '`Cocina`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Cocina->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Cocina'] = &$this->Cocina;

		// 1_Abrelatas
		$this->_1_Abrelatas = new cField('view_inv', 'view_inv', 'x__1_Abrelatas', '1_Abrelatas', '`1_Abrelatas`', '`1_Abrelatas`', 3, -1, FALSE, '`1_Abrelatas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Abrelatas->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Abrelatas'] = &$this->_1_Abrelatas;

		// 1_Balde
		$this->_1_Balde = new cField('view_inv', 'view_inv', 'x__1_Balde', '1_Balde', '`1_Balde`', '`1_Balde`', 3, -1, FALSE, '`1_Balde`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Balde->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Balde'] = &$this->_1_Balde;

		// 1_Arrocero_50
		$this->_1_Arrocero_50 = new cField('view_inv', 'view_inv', 'x__1_Arrocero_50', '1_Arrocero_50', '`1_Arrocero_50`', '`1_Arrocero_50`', 3, -1, FALSE, '`1_Arrocero_50`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Arrocero_50->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Arrocero_50'] = &$this->_1_Arrocero_50;

		// 1_Arrocero_44
		$this->_1_Arrocero_44 = new cField('view_inv', 'view_inv', 'x__1_Arrocero_44', '1_Arrocero_44', '`1_Arrocero_44`', '`1_Arrocero_44`', 3, -1, FALSE, '`1_Arrocero_44`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Arrocero_44->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Arrocero_44'] = &$this->_1_Arrocero_44;

		// 1_Chocolatera
		$this->_1_Chocolatera = new cField('view_inv', 'view_inv', 'x__1_Chocolatera', '1_Chocolatera', '`1_Chocolatera`', '`1_Chocolatera`', 3, -1, FALSE, '`1_Chocolatera`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Chocolatera->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Chocolatera'] = &$this->_1_Chocolatera;

		// 1_Colador
		$this->_1_Colador = new cField('view_inv', 'view_inv', 'x__1_Colador', '1_Colador', '`1_Colador`', '`1_Colador`', 3, -1, FALSE, '`1_Colador`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Colador->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Colador'] = &$this->_1_Colador;

		// 1_Cucharon_sopa
		$this->_1_Cucharon_sopa = new cField('view_inv', 'view_inv', 'x__1_Cucharon_sopa', '1_Cucharon_sopa', '`1_Cucharon_sopa`', '`1_Cucharon_sopa`', 3, -1, FALSE, '`1_Cucharon_sopa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Cucharon_sopa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Cucharon_sopa'] = &$this->_1_Cucharon_sopa;

		// 1_Cucharon_arroz
		$this->_1_Cucharon_arroz = new cField('view_inv', 'view_inv', 'x__1_Cucharon_arroz', '1_Cucharon_arroz', '`1_Cucharon_arroz`', '`1_Cucharon_arroz`', 3, -1, FALSE, '`1_Cucharon_arroz`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Cuchillo
		$this->_1_Cuchillo = new cField('view_inv', 'view_inv', 'x__1_Cuchillo', '1_Cuchillo', '`1_Cuchillo`', '`1_Cuchillo`', 3, -1, FALSE, '`1_Cuchillo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Cuchillo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Cuchillo'] = &$this->_1_Cuchillo;

		// 1_Embudo
		$this->_1_Embudo = new cField('view_inv', 'view_inv', 'x__1_Embudo', '1_Embudo', '`1_Embudo`', '`1_Embudo`', 3, -1, FALSE, '`1_Embudo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Embudo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Embudo'] = &$this->_1_Embudo;

		// 1_Espumera
		$this->_1_Espumera = new cField('view_inv', 'view_inv', 'x__1_Espumera', '1_Espumera', '`1_Espumera`', '`1_Espumera`', 3, -1, FALSE, '`1_Espumera`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Espumera->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Espumera'] = &$this->_1_Espumera;

		// 1_Estufa
		$this->_1_Estufa = new cField('view_inv', 'view_inv', 'x__1_Estufa', '1_Estufa', '`1_Estufa`', '`1_Estufa`', 3, -1, FALSE, '`1_Estufa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Estufa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Estufa'] = &$this->_1_Estufa;

		// 1_Cuchara_sopa
		$this->_1_Cuchara_sopa = new cField('view_inv', 'view_inv', 'x__1_Cuchara_sopa', '1_Cuchara_sopa', '`1_Cuchara_sopa`', '`1_Cuchara_sopa`', 3, -1, FALSE, '`1_Cuchara_sopa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Cuchara_sopa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Cuchara_sopa'] = &$this->_1_Cuchara_sopa;

		// 1_Recipiente
		$this->_1_Recipiente = new cField('view_inv', 'view_inv', 'x__1_Recipiente', '1_Recipiente', '`1_Recipiente`', '`1_Recipiente`', 3, -1, FALSE, '`1_Recipiente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Recipiente->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Recipiente'] = &$this->_1_Recipiente;

		// 1_Kit_Repue_estufa
		$this->_1_Kit_Repue_estufa = new cField('view_inv', 'view_inv', 'x__1_Kit_Repue_estufa', '1_Kit_Repue_estufa', '`1_Kit_Repue_estufa`', '`1_Kit_Repue_estufa`', 3, -1, FALSE, '`1_Kit_Repue_estufa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 1_Molinillo
		$this->_1_Molinillo = new cField('view_inv', 'view_inv', 'x__1_Molinillo', '1_Molinillo', '`1_Molinillo`', '`1_Molinillo`', 3, -1, FALSE, '`1_Molinillo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Molinillo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Molinillo'] = &$this->_1_Molinillo;

		// 1_Olla_36
		$this->_1_Olla_36 = new cField('view_inv', 'view_inv', 'x__1_Olla_36', '1_Olla_36', '`1_Olla_36`', '`1_Olla_36`', 3, -1, FALSE, '`1_Olla_36`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Olla_36->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Olla_36'] = &$this->_1_Olla_36;

		// 1_Olla_40
		$this->_1_Olla_40 = new cField('view_inv', 'view_inv', 'x__1_Olla_40', '1_Olla_40', '`1_Olla_40`', '`1_Olla_40`', 3, -1, FALSE, '`1_Olla_40`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Olla_40->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Olla_40'] = &$this->_1_Olla_40;

		// 1_Paila_32
		$this->_1_Paila_32 = new cField('view_inv', 'view_inv', 'x__1_Paila_32', '1_Paila_32', '`1_Paila_32`', '`1_Paila_32`', 3, -1, FALSE, '`1_Paila_32`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Paila_32->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Paila_32'] = &$this->_1_Paila_32;

		// 1_Paila_36_37
		$this->_1_Paila_36_37 = new cField('view_inv', 'view_inv', 'x__1_Paila_36_37', '1_Paila_36_37', '`1_Paila_36_37`', '`1_Paila_36_37`', 3, -1, FALSE, '`1_Paila_36_37`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_1_Paila_36_37->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['1_Paila_36_37'] = &$this->_1_Paila_36_37;

		// Camping
		$this->Camping = new cField('view_inv', 'view_inv', 'x_Camping', 'Camping', '`Camping`', '`Camping`', 131, -1, FALSE, '`Camping`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Camping->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Camping'] = &$this->Camping;

		// 2_Aislante
		$this->_2_Aislante = new cField('view_inv', 'view_inv', 'x__2_Aislante', '2_Aislante', '`2_Aislante`', '`2_Aislante`', 3, -1, FALSE, '`2_Aislante`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Aislante->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Aislante'] = &$this->_2_Aislante;

		// 2_Carpa_hamaca
		$this->_2_Carpa_hamaca = new cField('view_inv', 'view_inv', 'x__2_Carpa_hamaca', '2_Carpa_hamaca', '`2_Carpa_hamaca`', '`2_Carpa_hamaca`', 3, -1, FALSE, '`2_Carpa_hamaca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Carpa_hamaca->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Carpa_hamaca'] = &$this->_2_Carpa_hamaca;

		// 2_Carpa_rancho
		$this->_2_Carpa_rancho = new cField('view_inv', 'view_inv', 'x__2_Carpa_rancho', '2_Carpa_rancho', '`2_Carpa_rancho`', '`2_Carpa_rancho`', 3, -1, FALSE, '`2_Carpa_rancho`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Carpa_rancho->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Carpa_rancho'] = &$this->_2_Carpa_rancho;

		// 2_Fibra_rollo
		$this->_2_Fibra_rollo = new cField('view_inv', 'view_inv', 'x__2_Fibra_rollo', '2_Fibra_rollo', '`2_Fibra_rollo`', '`2_Fibra_rollo`', 3, -1, FALSE, '`2_Fibra_rollo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Fibra_rollo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Fibra_rollo'] = &$this->_2_Fibra_rollo;

		// 2_CAL
		$this->_2_CAL = new cField('view_inv', 'view_inv', 'x__2_CAL', '2_CAL', '`2_CAL`', '`2_CAL`', 3, -1, FALSE, '`2_CAL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_CAL->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_CAL'] = &$this->_2_CAL;

		// 2_Linterna
		$this->_2_Linterna = new cField('view_inv', 'view_inv', 'x__2_Linterna', '2_Linterna', '`2_Linterna`', '`2_Linterna`', 3, -1, FALSE, '`2_Linterna`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Linterna->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Linterna'] = &$this->_2_Linterna;

		// 2_Botiquin
		$this->_2_Botiquin = new cField('view_inv', 'view_inv', 'x__2_Botiquin', '2_Botiquin', '`2_Botiquin`', '`2_Botiquin`', 3, -1, FALSE, '`2_Botiquin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Botiquin->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Botiquin'] = &$this->_2_Botiquin;

		// 2_Mascara_filtro
		$this->_2_Mascara_filtro = new cField('view_inv', 'view_inv', 'x__2_Mascara_filtro', '2_Mascara_filtro', '`2_Mascara_filtro`', '`2_Mascara_filtro`', 3, -1, FALSE, '`2_Mascara_filtro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 2_Pimpina
		$this->_2_Pimpina = new cField('view_inv', 'view_inv', 'x__2_Pimpina', '2_Pimpina', '`2_Pimpina`', '`2_Pimpina`', 3, -1, FALSE, '`2_Pimpina`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Pimpina->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Pimpina'] = &$this->_2_Pimpina;

		// 2_Sleeping 
		$this->_2_SleepingA0 = new cField('view_inv', 'view_inv', 'x__2_SleepingA0', '2_Sleeping ', '`2_Sleeping `', '`2_Sleeping `', 3, -1, FALSE, '`2_Sleeping `', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_SleepingA0->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Sleeping '] = &$this->_2_SleepingA0;

		// 2_Plastico_negro
		$this->_2_Plastico_negro = new cField('view_inv', 'view_inv', 'x__2_Plastico_negro', '2_Plastico_negro', '`2_Plastico_negro`', '`2_Plastico_negro`', 3, -1, FALSE, '`2_Plastico_negro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 2_Tula_tropa
		$this->_2_Tula_tropa = new cField('view_inv', 'view_inv', 'x__2_Tula_tropa', '2_Tula_tropa', '`2_Tula_tropa`', '`2_Tula_tropa`', 3, -1, FALSE, '`2_Tula_tropa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Tula_tropa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Tula_tropa'] = &$this->_2_Tula_tropa;

		// 2_Camilla
		$this->_2_Camilla = new cField('view_inv', 'view_inv', 'x__2_Camilla', '2_Camilla', '`2_Camilla`', '`2_Camilla`', 3, -1, FALSE, '`2_Camilla`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_2_Camilla->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['2_Camilla'] = &$this->_2_Camilla;

		// Herramientas
		$this->Herramientas = new cField('view_inv', 'view_inv', 'x_Herramientas', 'Herramientas', '`Herramientas`', '`Herramientas`', 131, -1, FALSE, '`Herramientas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Herramientas->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Herramientas'] = &$this->Herramientas;

		// 3_Abrazadera
		$this->_3_Abrazadera = new cField('view_inv', 'view_inv', 'x__3_Abrazadera', '3_Abrazadera', '`3_Abrazadera`', '`3_Abrazadera`', 3, -1, FALSE, '`3_Abrazadera`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Abrazadera->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Abrazadera'] = &$this->_3_Abrazadera;

		// 3_Aspersora
		$this->_3_Aspersora = new cField('view_inv', 'view_inv', 'x__3_Aspersora', '3_Aspersora', '`3_Aspersora`', '`3_Aspersora`', 3, -1, FALSE, '`3_Aspersora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Aspersora->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Aspersora'] = &$this->_3_Aspersora;

		// 3_Cabo_hacha
		$this->_3_Cabo_hacha = new cField('view_inv', 'view_inv', 'x__3_Cabo_hacha', '3_Cabo_hacha', '`3_Cabo_hacha`', '`3_Cabo_hacha`', 3, -1, FALSE, '`3_Cabo_hacha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Cabo_hacha->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Cabo_hacha'] = &$this->_3_Cabo_hacha;

		// 3_Funda_machete
		$this->_3_Funda_machete = new cField('view_inv', 'view_inv', 'x__3_Funda_machete', '3_Funda_machete', '`3_Funda_machete`', '`3_Funda_machete`', 3, -1, FALSE, '`3_Funda_machete`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Funda_machete->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Funda_machete'] = &$this->_3_Funda_machete;

		// 3_Glifosato_4lt
		$this->_3_Glifosato_4lt = new cField('view_inv', 'view_inv', 'x__3_Glifosato_4lt', '3_Glifosato_4lt', '`3_Glifosato_4lt`', '`3_Glifosato_4lt`', 3, -1, FALSE, '`3_Glifosato_4lt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Glifosato_4lt->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Glifosato_4lt'] = &$this->_3_Glifosato_4lt;

		// 3_Hacha
		$this->_3_Hacha = new cField('view_inv', 'view_inv', 'x__3_Hacha', '3_Hacha', '`3_Hacha`', '`3_Hacha`', 3, -1, FALSE, '`3_Hacha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Hacha->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Hacha'] = &$this->_3_Hacha;

		// 3_Lima_12_uni
		$this->_3_Lima_12_uni = new cField('view_inv', 'view_inv', 'x__3_Lima_12_uni', '3_Lima_12_uni', '`3_Lima_12_uni`', '`3_Lima_12_uni`', 3, -1, FALSE, '`3_Lima_12_uni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Lima_12_uni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Lima_12_uni'] = &$this->_3_Lima_12_uni;

		// 3_Llave_mixta
		$this->_3_Llave_mixta = new cField('view_inv', 'view_inv', 'x__3_Llave_mixta', '3_Llave_mixta', '`3_Llave_mixta`', '`3_Llave_mixta`', 3, -1, FALSE, '`3_Llave_mixta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Llave_mixta->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Llave_mixta'] = &$this->_3_Llave_mixta;

		// 3_Machete
		$this->_3_Machete = new cField('view_inv', 'view_inv', 'x__3_Machete', '3_Machete', '`3_Machete`', '`3_Machete`', 3, -1, FALSE, '`3_Machete`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Machete->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Machete'] = &$this->_3_Machete;

		// 3_Gafa_traslucida
		$this->_3_Gafa_traslucida = new cField('view_inv', 'view_inv', 'x__3_Gafa_traslucida', '3_Gafa_traslucida', '`3_Gafa_traslucida`', '`3_Gafa_traslucida`', 3, -1, FALSE, '`3_Gafa_traslucida`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// 3_Motosierra
		$this->_3_Motosierra = new cField('view_inv', 'view_inv', 'x__3_Motosierra', '3_Motosierra', '`3_Motosierra`', '`3_Motosierra`', 3, -1, FALSE, '`3_Motosierra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_3_Motosierra->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['3_Motosierra'] = &$this->_3_Motosierra;

		// 3_Palin
		$this->_3_Palin = new cField('view_inv', 'view_inv', 'x__3_Palin', '3_Palin', '`3_Palin`', '`3_Palin`', 3, -1, FALSE, '`3_Palin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_inv`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_invview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_invview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_invadd.php?" . $this->UrlParm($parm);
		else
			return "view_invadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_invedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_invadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_invdelete.php", $this->UrlParm());
	}
