...
$grafica_apoyos_zonales = NULL;

//
// Table class for grafica_apoyos_zonales
//
class cgrafica_apoyos_zonales extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'grafica_apoyos_zonales';
		$this->TableName = 'grafica_apoyos_zonales';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		$this->Profesional_Especializado = new cField('grafica_apoyos_zonales', 'grafica_apoyos_zonales', 'x_Profesional_Especializado', 'Profesional_Especializado', '`Profesional_Especializado`', '`Profesional_Especializado`', 201, -1, FALSE, '`Profesional_Especializado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Profesional_Especializado'] = &$this->Profesional_Especializado;

		// Punto
		$this->Punto = new cField('grafica_apoyos_zonales', 'grafica_apoyos_zonales', 'x_Punto', 'Punto', '`Punto`', '`Punto`', 201, -1, FALSE, '`Punto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Punto'] = &$this->Punto;

		// Apoyo_zonal
		$this->Apoyo_zonal = new cField('grafica_apoyos_zonales', 'grafica_apoyos_zonales', 'x_Apoyo_zonal', 'Apoyo_zonal', '`Apoyo_zonal`', '`Apoyo_zonal`', 201, -1, FALSE, '`Apoyo_zonal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Apoyo_zonal'] = &$this->Apoyo_zonal;

		// Cargo
		$this->Cargo = new cField('grafica_apoyos_zonales', 'grafica_apoyos_zonales', 'x_Cargo', 'Cargo', '`Cargo`', '`Cargo`', 200, -1, FALSE, '`Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`grafica_apoyos_zonales`";
	}
	...
	// Update Table
	var $UpdateTable = "`grafica_apoyos_zonales`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "grafica_apoyos_zonaleslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("grafica_apoyos_zonalesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("grafica_apoyos_zonalesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "grafica_apoyos_zonalesadd.php?" . $this->UrlParm($parm);
		else
			return "grafica_apoyos_zonalesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("grafica_apoyos_zonalesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("grafica_apoyos_zonalesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("grafica_apoyos_zonalesdelete.php", $this->UrlParm());
	}
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->Apoyo_zonal->Exportable) $Doc->ExportCaption($this->Apoyo_zonal);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->Apoyo_zonal->Exportable) $Doc->ExportField($this->Apoyo_zonal);
