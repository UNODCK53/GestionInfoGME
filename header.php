...
<link rel="stylesheet" href="bootstrap3/css/styles.css">
<?php } ?>
<?php if (@$gsExport == "" || @$gsExport == "print") { ?>
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow"  align="center"  class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/geografica.png" alt=""style="border: 0;width: 80%;"><hr class="style-four"></div>
<?php if (ew_IsResponsiveLayout()) { ?>
