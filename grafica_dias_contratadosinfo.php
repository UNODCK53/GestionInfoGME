...
$grafica_dias_contratados = NULL;

//
// Table class for grafica_dias_contratados
//
class cgrafica_dias_contratados extends cTable {
	var $Punto;
	var $Profesional;
	...
	function __construct() {
		...
		$this->TableVar = 'grafica_dias_contratados';
		$this->TableName = 'grafica_dias_contratados';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Punto
		$this->Punto = new cField('grafica_dias_contratados', 'grafica_dias_contratados', 'x_Punto', 'Punto', '`Punto`', '`Punto`', 201, -1, FALSE, '`Punto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Punto'] = &$this->Punto;

		// Profesional
		$this->Profesional = new cField('grafica_dias_contratados', 'grafica_dias_contratados', 'x_Profesional', 'Profesional', '`Profesional`', '`Profesional`', 201, -1, FALSE, '`Profesional`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Profesional'] = &$this->Profesional;

		// Firma_Contrato_Gme
		$this->Firma_Contrato_Gme = new cField('grafica_dias_contratados', 'grafica_dias_contratados', 'x_Firma_Contrato_Gme', 'Firma_Contrato_Gme', '`Firma_Contrato_Gme`', '`Firma_Contrato_Gme`', 200, -1, FALSE, '`Firma_Contrato_Gme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Firma_Contrato_Gme'] = &$this->Firma_Contrato_Gme;

		// Llegada_GME_a_su_lugar_de_Origen
		$this->Llegada_GME_a_su_lugar_de_Origen = new cField('grafica_dias_contratados', 'grafica_dias_contratados', 'x_Llegada_GME_a_su_lugar_de_Origen', 'Llegada_GME_a_su_lugar_de_Origen', '`Llegada_GME_a_su_lugar_de_Origen`', '`Llegada_GME_a_su_lugar_de_Origen`', 200, -1, FALSE, '`Llegada_GME_a_su_lugar_de_Origen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`grafica_dias_contratados`";
	}
	...
	// Update Table
	var $UpdateTable = "`grafica_dias_contratados`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "grafica_dias_contratadoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("grafica_dias_contratadosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("grafica_dias_contratadosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "grafica_dias_contratadosadd.php?" . $this->UrlParm($parm);
		else
			return "grafica_dias_contratadosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("grafica_dias_contratadosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("grafica_dias_contratadosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("grafica_dias_contratadosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Firma_Contrato_Gme->EditValue = ew_HtmlEncode($this->Firma_Contrato_Gme->CurrentValue);
		...
		$this->Llegada_GME_a_su_lugar_de_Origen->EditValue = ew_HtmlEncode($this->Llegada_GME_a_su_lugar_de_Origen->CurrentValue);
