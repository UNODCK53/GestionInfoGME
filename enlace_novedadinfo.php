...
//
// Table class for enlace_novedad
//
class cenlace_novedad extends cTable {
	var $ID_Formulario;
	var $USUARIO;
	var $Cargo_gme;
	var $NOM_GE;
	...
	function __construct() {
		...
		$this->TableVar = 'enlace_novedad';
		$this->TableName = 'enlace_novedad';
		...
		// ID_Formulario
		$this->ID_Formulario = new cField('enlace_novedad', 'enlace_novedad', 'x_ID_Formulario', 'ID_Formulario', '`ID_Formulario`', '`ID_Formulario`', 200, -1, FALSE, '`ID_Formulario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ID_Formulario'] = &$this->ID_Formulario;

		// USUARIO
		$this->USUARIO = new cField('enlace_novedad', 'enlace_novedad', 'x_USUARIO', 'USUARIO', '`USUARIO`', '`USUARIO`', 201, -1, FALSE, '`USUARIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['USUARIO'] = &$this->USUARIO;

		// Cargo_gme
		$this->Cargo_gme = new cField('enlace_novedad', 'enlace_novedad', 'x_Cargo_gme', 'Cargo_gme', '`Cargo_gme`', '`Cargo_gme`', 200, -1, FALSE, '`Cargo_gme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cargo_gme'] = &$this->Cargo_gme;

		// NOM_GE
		$this->NOM_GE = new cField('enlace_novedad', 'enlace_novedad', 'x_NOM_GE', 'NOM_GE', '`NOM_GE`', '`NOM_GE`', 201, -1, FALSE, '`NOM_GE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_GE'] = &$this->NOM_GE;

		// Otro_PGE
		$this->Otro_PGE = new cField('enlace_novedad', 'enlace_novedad', 'x_Otro_PGE', 'Otro_PGE', '`Otro_PGE`', '`Otro_PGE`', 200, -1, FALSE, '`Otro_PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_PGE'] = &$this->Otro_PGE;

		// Otro_CC_PGE
		$this->Otro_CC_PGE = new cField('enlace_novedad', 'enlace_novedad', 'x_Otro_CC_PGE', 'Otro_CC_PGE', '`Otro_CC_PGE`', '`Otro_CC_PGE`', 200, -1, FALSE, '`Otro_CC_PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_CC_PGE'] = &$this->Otro_CC_PGE;

		// TIPO_INFORME
		$this->TIPO_INFORME = new cField('enlace_novedad', 'enlace_novedad', 'x_TIPO_INFORME', 'TIPO_INFORME', '`TIPO_INFORME`', '`TIPO_INFORME`', 201, -1, FALSE, '`TIPO_INFORME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TIPO_INFORME'] = &$this->TIPO_INFORME;

		// FECHA_NOVEDAD
		$this->FECHA_NOVEDAD = new cField('enlace_novedad', 'enlace_novedad', 'x_FECHA_NOVEDAD', 'FECHA_NOVEDAD', '`FECHA_NOVEDAD`', '`FECHA_NOVEDAD`', 200, -1, FALSE, '`FECHA_NOVEDAD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FECHA_NOVEDAD'] = &$this->FECHA_NOVEDAD;

		// DIA
		$this->DIA = new cField('enlace_novedad', 'enlace_novedad', 'x_DIA', 'DIA', '`DIA`', '`DIA`', 200, -1, FALSE, '`DIA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['DIA'] = &$this->DIA;

		// MES
		$this->MES = new cField('enlace_novedad', 'enlace_novedad', 'x_MES', 'MES', '`MES`', '`MES`', 200, -1, FALSE, '`MES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MES'] = &$this->MES;

		// Num_Evacua
		$this->Num_Evacua = new cField('enlace_novedad', 'enlace_novedad', 'x_Num_Evacua', 'Num_Evacua', '`Num_Evacua`', '`Num_Evacua`', 3, -1, FALSE, '`Num_Evacua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Num_Evacua->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Num_Evacua'] = &$this->Num_Evacua;

		// PTO_INCOMU
		$this->PTO_INCOMU = new cField('enlace_novedad', 'enlace_novedad', 'x_PTO_INCOMU', 'PTO_INCOMU', '`PTO_INCOMU`', '`PTO_INCOMU`', 201, -1, FALSE, '`PTO_INCOMU`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PTO_INCOMU'] = &$this->PTO_INCOMU;

		// OBS_punt_inco
		$this->OBS_punt_inco = new cField('enlace_novedad', 'enlace_novedad', 'x_OBS_punt_inco', 'OBS_punt_inco', '`OBS_punt_inco`', '`OBS_punt_inco`', 201, -1, FALSE, '`OBS_punt_inco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBS_punt_inco'] = &$this->OBS_punt_inco;

		// OBS_ENLACE
		$this->OBS_ENLACE = new cField('enlace_novedad', 'enlace_novedad', 'x_OBS_ENLACE', 'OBS_ENLACE', '`OBS_ENLACE`', '`OBS_ENLACE`', 201, -1, FALSE, '`OBS_ENLACE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBS_ENLACE'] = &$this->OBS_ENLACE;

		// Nom_Per_Evacu
		$this->Nom_Per_Evacu = new cField('enlace_novedad', 'enlace_novedad', 'x_Nom_Per_Evacu', 'Nom_Per_Evacu', '`Nom_Per_Evacu`', '`Nom_Per_Evacu`', 201, -1, FALSE, '`Nom_Per_Evacu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nom_Per_Evacu'] = &$this->Nom_Per_Evacu;

		// Nom_Otro_Per_Evacu
		$this->Nom_Otro_Per_Evacu = new cField('enlace_novedad', 'enlace_novedad', 'x_Nom_Otro_Per_Evacu', 'Nom_Otro_Per_Evacu', '`Nom_Otro_Per_Evacu`', '`Nom_Otro_Per_Evacu`', 200, -1, FALSE, '`Nom_Otro_Per_Evacu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nom_Otro_Per_Evacu'] = &$this->Nom_Otro_Per_Evacu;

		// CC_Otro_Per_Evacu
		$this->CC_Otro_Per_Evacu = new cField('enlace_novedad', 'enlace_novedad', 'x_CC_Otro_Per_Evacu', 'CC_Otro_Per_Evacu', '`CC_Otro_Per_Evacu`', '`CC_Otro_Per_Evacu`', 200, -1, FALSE, '`CC_Otro_Per_Evacu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CC_Otro_Per_Evacu'] = &$this->CC_Otro_Per_Evacu;

		// Cargo_Per_EVA
		$this->Cargo_Per_EVA = new cField('enlace_novedad', 'enlace_novedad', 'x_Cargo_Per_EVA', 'Cargo_Per_EVA', '`Cargo_Per_EVA`', '`Cargo_Per_EVA`', 201, -1, FALSE, '`Cargo_Per_EVA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cargo_Per_EVA'] = &$this->Cargo_Per_EVA;

		// Motivo_Eva
		$this->Motivo_Eva = new cField('enlace_novedad', 'enlace_novedad', 'x_Motivo_Eva', 'Motivo_Eva', '`Motivo_Eva`', '`Motivo_Eva`', 201, -1, FALSE, '`Motivo_Eva`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Motivo_Eva'] = &$this->Motivo_Eva;

		// OBS_EVA
		$this->OBS_EVA = new cField('enlace_novedad', 'enlace_novedad', 'x_OBS_EVA', 'OBS_EVA', '`OBS_EVA`', '`OBS_EVA`', 201, -1, FALSE, '`OBS_EVA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['OBS_EVA'] = &$this->OBS_EVA;

		// NOM_PE
		$this->NOM_PE = new cField('enlace_novedad', 'enlace_novedad', 'x_NOM_PE', 'NOM_PE', '`NOM_PE`', '`NOM_PE`', 201, -1, FALSE, '`NOM_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_PE'] = &$this->NOM_PE;

		// Otro_Nom_PE
		$this->Otro_Nom_PE = new cField('enlace_novedad', 'enlace_novedad', 'x_Otro_Nom_PE', 'Otro_Nom_PE', '`Otro_Nom_PE`', '`Otro_Nom_PE`', 200, -1, FALSE, '`Otro_Nom_PE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_Nom_PE'] = &$this->Otro_Nom_PE;

		// NOM_CAPATAZ
		$this->NOM_CAPATAZ = new cField('enlace_novedad', 'enlace_novedad', 'x_NOM_CAPATAZ', 'NOM_CAPATAZ', '`NOM_CAPATAZ`', '`NOM_CAPATAZ`', 201, -1, FALSE, '`NOM_CAPATAZ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOM_CAPATAZ'] = &$this->NOM_CAPATAZ;

		// Otro_Nom_Capata
		$this->Otro_Nom_Capata = new cField('enlace_novedad', 'enlace_novedad', 'x_Otro_Nom_Capata', 'Otro_Nom_Capata', '`Otro_Nom_Capata`', '`Otro_Nom_Capata`', 200, -1, FALSE, '`Otro_Nom_Capata`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_Nom_Capata'] = &$this->Otro_Nom_Capata;

		// Otro_CC_Capata
		$this->Otro_CC_Capata = new cField('enlace_novedad', 'enlace_novedad', 'x_Otro_CC_Capata', 'Otro_CC_Capata', '`Otro_CC_Capata`', '`Otro_CC_Capata`', 200, -1, FALSE, '`Otro_CC_Capata`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Otro_CC_Capata'] = &$this->Otro_CC_Capata;

		// Muncipio
		$this->Muncipio = new cField('enlace_novedad', 'enlace_novedad', 'x_Muncipio', 'Muncipio', '`Muncipio`', '`Muncipio`', 201, -1, FALSE, '`Muncipio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Muncipio'] = &$this->Muncipio;

		// Departamento
		$this->Departamento = new cField('enlace_novedad', 'enlace_novedad', 'x_Departamento', 'Departamento', '`Departamento`', '`Departamento`', 200, -1, FALSE, '`Departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Departamento'] = &$this->Departamento;

		// F_llegada
		$this->F_llegada = new cField('enlace_novedad', 'enlace_novedad', 'x_F_llegada', 'F_llegada', '`F_llegada`', '`F_llegada`', 201, -1, FALSE, '`F_llegada`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['F_llegada'] = &$this->F_llegada;

		// Fecha
		$this->Fecha = new cField('enlace_novedad', 'enlace_novedad', 'x_Fecha', 'Fecha', '`Fecha`', '`Fecha`', 200, -1, FALSE, '`Fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Fecha'] = &$this->Fecha;

		// F_Sincron
		$this->F_Sincron = new cField('enlace_novedad', 'enlace_novedad', 'x_F_Sincron', 'F_Sincron', '`F_Sincron`', 'DATE_FORMAT(`F_Sincron`, \'%d/%m/%Y\')', 135, 7, FALSE, '`F_Sincron`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->F_Sincron->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['F_Sincron'] = &$this->F_Sincron;

		// NUM_Novedad
		$this->NUM_Novedad = new cField('enlace_novedad', 'enlace_novedad', 'x_NUM_Novedad', 'NUM_Novedad', '`NUM_Novedad`', '`NUM_Novedad`', 3, -1, FALSE, '`NUM_Novedad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`enlace_novedad`";
	}
	...
	// Update Table
	var $UpdateTable = "`enlace_novedad`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("enlace_novedadview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("enlace_novedadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "enlace_novedadadd.php?" . $this->UrlParm($parm);
		else
			return "enlace_novedadadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("enlace_novedadedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("enlace_novedadadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("enlace_novedaddelete.php", $this->UrlParm());
	}
