...
$grafica_intervencion_geografica = NULL;

//
// Table class for grafica_intervencion_geografica
//
class cgrafica_intervencion_geografica extends cTable {
	var $Departamento;
	var $Muncipio;
	var $Ha_Coca;
	var $Ha_Amapola;
	...
	function __construct() {
		...
		$this->TableVar = 'grafica_intervencion_geografica';
		$this->TableName = 'grafica_intervencion_geografica';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Departamento
		$this->Departamento = new cField('grafica_intervencion_geografica', 'grafica_intervencion_geografica', 'x_Departamento', 'Departamento', '`Departamento`', '`Departamento`', 200, -1, FALSE, '`Departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Departamento'] = &$this->Departamento;

		// Muncipio
		$this->Muncipio = new cField('grafica_intervencion_geografica', 'grafica_intervencion_geografica', 'x_Muncipio', 'Muncipio', '`Muncipio`', '`Muncipio`', 201, -1, FALSE, '`Muncipio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Muncipio'] = &$this->Muncipio;

		// Ha_Coca
		$this->Ha_Coca = new cField('grafica_intervencion_geografica', 'grafica_intervencion_geografica', 'x_Ha_Coca', 'Ha_Coca', '`Ha_Coca`', '`Ha_Coca`', 131, -1, FALSE, '`Ha_Coca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ha_Coca->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ha_Coca'] = &$this->Ha_Coca;

		// Ha_Amapola
		$this->Ha_Amapola = new cField('grafica_intervencion_geografica', 'grafica_intervencion_geografica', 'x_Ha_Amapola', 'Ha_Amapola', '`Ha_Amapola`', '`Ha_Amapola`', 131, -1, FALSE, '`Ha_Amapola`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Ha_Amapola->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Ha_Amapola'] = &$this->Ha_Amapola;

		// Ha_Marihuana
		$this->Ha_Marihuana = new cField('grafica_intervencion_geografica', 'grafica_intervencion_geografica', 'x_Ha_Marihuana', 'Ha_Marihuana', '`Ha_Marihuana`', '`Ha_Marihuana`', 131, -1, FALSE, '`Ha_Marihuana`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`grafica_intervencion_geografica`";
	}
	...
	// Update Table
	var $UpdateTable = "`grafica_intervencion_geografica`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "grafica_intervencion_geograficalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("grafica_intervencion_geograficaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("grafica_intervencion_geograficaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "grafica_intervencion_geograficaadd.php?" . $this->UrlParm($parm);
		else
			return "grafica_intervencion_geograficaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("grafica_intervencion_geograficaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("grafica_intervencion_geograficaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("grafica_intervencion_geograficadelete.php", $this->UrlParm());
	}
